...
IN1=$PWD/trinity_genes.fasta
OUT=$IN1.transdecoder_dir
IN2=$OUT/longest_orfs.pep
OUT2=$OUT/longest_orfs.pep.all.vs_Knitens_NIES2285_prots.outfmt6 #Change this
REFERENCE_GENOME= #Change this to your reference genome
...
#makeblastdb -in [REFERENCE_GENOME.fa] -parse_seqids -title "Combined_Klebso_DB" -dbtype prot -blastdb_version 4 #We work with version 4
